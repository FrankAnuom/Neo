            ...
            >
              <div className="relative overflow-hidden">
                ...
                >
                  ...
                  <button className="w-8 h-8 bg-white/90 rounded-full flex items-center justify-center hover:bg-blue-800 transition-all duration-300">
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-1 mb-4">
                  {project.technologies.map((tech, techIndex) => (
                    <span
                      key={techIndex}
                      className="bg-blue-800 text-white px-2 py-1 rounded-full text-xs font-medium"
                    >
                      {tech}
                    </span>
                  ))}
